            ...
            child: Row(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 4,),
                        Text('WLS', style: const TextStyle(fontSize: 11,fontWeight: FontWeight.bold,color: Colors.white)),
                      ],
                    ),
                  ],
                ),
                ...
                Padding(
                  ...
                  child: Text(time, style: const TextStyle(fontWeight: FontWeight.bold,color: Colors.greenAccent)),
                ),
